...
export const EditCompanySubscriptionModal: React.FC<
  EditCompanySubscriptionModalProps
> = ({ subscription, onCancel, onSuccess }) => {
  const [form] = Form.useForm();
  const { updateMutation } = useCompanySubscriptionsMutations(
    subscription.company_subscription_id
  );
      ...
      title={
        ...
        >
          ...
          <span style={{ fontSize: "18px", fontWeight: "600" }}>
            Редактирование подписки компании
          </span>
        </div>
      }
      open={true}
